...
DROP TABLE IF EXISTS OFFICE_GENRE;
DROP TABLE IF EXISTS OFFICE_REF;
DROP TABLE IF EXISTS OFFICE_DETAIL;
DROP TABLE IF EXISTS STAFF_INFO;
DROP TABLE IF EXISTS TALENT_GENRE;
DROP TABLE IF EXISTS OUTPATIENT_SERVICE;
DROP TABLE IF EXISTS LEADER_GROUP_REF;
DROP TABLE IF EXISTS LEADER_INFO;
DROP TABLE IF EXISTS DOCTOR_OFFICE_REF;
DROP TABLE IF EXISTS DOCTOR_TALENT_REF;
DROP TABLE IF EXISTS DOCTOR_INFO;
DROP TABLE IF EXISTS USESR_DEPT_REF;
...
CREATE TABLE OFFICE_DETAIL  (
   ...
   OD_DESC               VARCHAR(4096),
   OD_ACADEMIC_POSITION  VARCHAR(4096),
   OD_TECH_ADV           VARCHAR(4096),
   OD_RESEARCH_DIRECTION VARCHAR(4096),
   PRIMARY KEY (OD_ID)
) type=InnoDB;
